// this code was taken directly from the nonlinearTseries package 
// Constantino A. Garcia (2015). nonlinearTseries: Nonlinear Time Series Analysis. R
// package version 0.2.3. https://CRAN.R-project.org/package=nonlinearTseries
